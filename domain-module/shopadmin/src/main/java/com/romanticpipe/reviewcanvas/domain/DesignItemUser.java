...
public class DesignItemUser {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "design_item_user_id")
	private Long id;
	...
	@Builder
	public DesignItemUser(String themeName, String layoutType, String padding, String gap, String boxShadowColor,
		int boxShadowWidth,
		...
		String pointType, int lineEllipsis, Boolean activate, Long shopAdminId) {
