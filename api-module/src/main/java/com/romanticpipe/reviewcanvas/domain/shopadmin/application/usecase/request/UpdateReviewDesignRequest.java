...
public record UpdateReviewDesignRequest(@Schema(description = "리뷰 디자인 포지션", requiredMode = Schema.RequiredMode.REQUIRED)
										...
										@NotBlank String gap,
										@Schema(description = "Shadow의 색상", requiredMode = Schema.RequiredMode.REQUIRED)
										String boxShadowColor,
										@Schema(description = "Shadow의 너비", requiredMode = Schema.RequiredMode.REQUIRED)
										int boxShadowWidth,
										...
										@NotNull int lineEllipsis,
										@Schema(description = "리뷰 디자인 이미지 url", requiredMode = Schema.RequiredMode.REQUIRED)
